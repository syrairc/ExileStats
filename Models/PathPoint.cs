...
/// field names) because these are logged many times per second: <see cref="T"/> = elapsed seconds since
/// this visit started, <see cref="X"/>/<see cref="Y"/> = player <c>GridPos</c>, <see cref="Z"/> = ZoneSwitchId
